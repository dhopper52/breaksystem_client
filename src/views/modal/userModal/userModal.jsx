  ...
  return (
    <div className="user-modal-container">
      <div className="user-modal-header">
        <h2 className="user-modal-title">Create User</h2>
        <p className="user-modal-subtitle">Add a new user to the system</p>
      </div>
      ...
      <div className="user-modal-content">
        ...
        >
          <div className="row">
            <div className="col-lg-6 col-md-12">
              <div className="form-group">
                ...
                <InputGroup>
                  <InputGrouptext>
                    <i className="fa-regular fa-user color-gray"></i>
                  </InputGrouptext>
                  <Form.Control
                    type="number"
          ...
          <div className="row">
            <div className="col-lg-6 col-md-12">
              <div className="form-group">
                <FormLabel className="form-label">Shift Hours</FormLabel>
                <InputGroup>
                  <InputGrouptext>
            ...
            {localUser?.role === roleType.SUPER_ADMIN ? (
              <div className="col-lg-6 col-md-12">
                <div className="form-group">
                  ...
                  <InputGroup>
                    <InputGrouptext>
                      <i className="fa-solid fa-bars-progress color-gray"></i>
                    </InputGrouptext>
                    <Form.Select
                      className={`form-select ${
          ...
          <div className="time-picker-section">
            <div className="time-picker-row">
              <div className="time-picker-group">
                <FormLabel className="time-picker-label">Shift Starts</FormLabel>
                <Controller
                  name="shiftStarts"
                  control={control}
                  defaultValue=""
              ...
              <div className="time-picker-group">
                <FormLabel className="time-picker-label">Shift Ends</FormLabel>
                <Controller
                  name="shiftEnds"
                  control={control}
                  defaultValue=""
